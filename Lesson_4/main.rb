...
def edit_train
  ...
  puts "Вы выбрали поезд #{train}. Какую операцию хотите провести?"
...
# Можно добавить еще много приятной косметики вроде правильного вывода номеров поезда или красивого вывода списов,
